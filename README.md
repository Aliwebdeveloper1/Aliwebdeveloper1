...
**2024 – PRESENT: Full Stack Developer (MERN)**
...
**Tech Stack:** Express, REST API, MongoDB, AWS
...
| Principle       | Belief                               |
| :-------------- | :----------------------------------- |
| 🏗️ Architecture | Build for scale from day one         |
| 🧹 Clean Code   | Code is read 10× more than written   |
| 🔄 Iterate      | Ship fast, learn, improve            |
